...
class BaseController():
    ...
    def __init__(self, services_timeout: float = 60) -> None:
        ...
        self.saved_position = [0.0, 0.0, 1.0]
        ...
        self._check_for_services(services_timeout)
        assert self._enable_mavros_topics()
    ...
    def _check_for_services(self, services_timeout: float) -> None:
    ...
    def _enable_mavros_topics(self) -> bool:
    ...
    def point_from_distance_rotation(self, step : float, altitude : float = None):
        """
        Convert an Euler angle to a quaternion.

        Params:
        --
        z: altitude to navigate
        step: absolute distance to goes based in currente position

        Returns:
        --
        [dx, dy, z] = distance to move in x axis, distance to move in y axis and ltitude to navigate
        """
    ...
    def set_turne(self, turne: float = 0.0) -> bool:
        ...
        try:
            ...
            p_x, p_y, p_z = self.saved_position
    ...
    def is_target_position(self, target_position: list = [0.0, 0.0, 0.0], \
